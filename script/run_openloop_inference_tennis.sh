...
python -m wan_va.tennis.openloop_inference_tennis \
    ...
    --dataset-root /efs-mi-east4-2/lijianwen/Datasets/Tennis/tennis_val/tennis_dataset_lerobot_0818_small65mm_45steps_1000episodes_new \
    --episode-index 1 \
    --sample-fps 15 \
    --prefix-num-frames 9 \
    ...
    --output-fps 15 \
    --save-root /efs-mi-east4-2/lijianwen/Codes/lingbot-vggt/outputs/openloop_outputs \
    --plot-trajectory
